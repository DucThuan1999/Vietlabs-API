...
{
    /// <inheritdoc />
    public partial class AddOrderTemplateTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "order_template_analysis_group",
                columns: table => new
                {
                    order_template_analysis_group_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_template_analysis_group", x => x.order_template_analysis_group_id);
                    table.ForeignKey(
                        name: "f_k_order_template_analysis_group_account_updated_by",
                        column: x => x.updated_by,
                        principalTable: "account",
                        principalColumn: "account_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "f_k_order_template_analysis_group_analysis_group_analysis_group_id",
            ...
            migrationBuilder.CreateTable(
                name: "order_template_item",
                columns: table => new
                {
                    order_template_item_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    order_sample_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_template_item", x => x.order_template_item_id);
                    table.ForeignKey(
                        name: "f_k_order_template_item_account_updated_by",
                        column: x => x.updated_by,
                        principalTable: "account",
                        principalColumn: "account_id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "f_k_order_template_item_department_analysis_capability_department_analysis_capability_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "f_k_order_template_item_subcontractor_capability_subcontractor_capability_id",
            ...
            migrationBuilder.CreateTable(
                name: "order_template_package",
                columns: table => new
                {
                    order_template_package_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    order_sample_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_template_package", x => x.order_template_package_id);
                    table.ForeignKey(
                        name: "f_k_order_template_package_account_updated_by",
                        column: x => x.updated_by,
                        principalTable: "account",
                        principalColumn: "account_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "f_k_order_template_package_sample_matrix_sample_matrix_id",
            ...
            migrationBuilder.CreateTable(
                name: "order_template_package_analysis_item",
                columns: table => new
                {
                    order_template_package_analysis_item_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    order_template_package_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_template_package_analysis_item", x => x.order_template_package_analysis_item_id);
                    table.ForeignKey(
                        name: "f_k_order_template_package_analysis_item_account_updated_by",
                        column: x => x.updated_by,
                        principalTable: "account",
                        principalColumn: "account_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "f_k_order_template_package_analysis_item_analysis_item_analysis_item_id",
                        column: x => x.analysis_item_id,
                        principalTable: "analysis_item",
                        principalColumn: "analysis_item_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "f_k_order_template_package_analysis_item_order_template_package_order_template_package_id",
                        column: x => x.order_template_package_id,
                        principalTable: "order_template_package",
                        principalColumn: "order_template_package_id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_analysis_group_analysis_group_id",
                table: "order_template_analysis_group",
                column: "analysis_group_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_analysis_group_updated_by",
                table: "order_template_analysis_group",
                column: "updated_by");
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_order_template_item_analysis_group_id",
                table: "order_template_item",
                column: "analysis_group_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_item_analysis_item_id",
                table: "order_template_item",
                column: "analysis_item_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_item_department_analysis_capability_id",
                table: "order_template_item",
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_order_template_item_package_id",
                table: "order_template_item",
                column: "package_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_item_subcontractor_capability_id",
                table: "order_template_item",
                column: "subcontractor_capability_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_item_updated_by",
                table: "order_template_item",
                column: "updated_by");
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_order_template_package_sample_matrix_id",
                table: "order_template_package",
                column: "sample_matrix_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_package_updated_by",
                table: "order_template_package",
                column: "updated_by");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_package_analysis_item_analysis_item_id",
                table: "order_template_package_analysis_item",
                column: "analysis_item_id");

            migrationBuilder.CreateIndex(
                name: "i_x_order_template_package_analysis_item_updated_by",
                table: "order_template_package_analysis_item",
                column: "updated_by");

            migrationBuilder.CreateIndex(
                name: "u_q_order_template_package_analysis_item_pkg_item",
                table: "order_template_package_analysis_item",
                columns: new[] { "order_template_package_id", "analysis_item_id" },
                unique: true);
        }
