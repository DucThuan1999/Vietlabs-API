...
public class OrderSampleItemConfiguration : IEntityTypeConfiguration<OrderSampleItem>
{
    public void Configure(EntityTypeBuilder<OrderSampleItem> builder)
    {
        builder.ToTable("order_sample_item");

        builder.HasKey(qi => qi.OrderSampleItemId);

        builder.Property(qi => qi.OrderSampleItemId)
            .HasColumnName("order_sample_item_id");

        builder.Property(qi => qi.OrderSampleId)
