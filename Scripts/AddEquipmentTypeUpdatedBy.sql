-- =============================================
-- Thêm cột created_at, updated_at, updated_by vào equipment_type
-- =============================================
...
BEGIN
    ...
    PRINT N'Đã thêm cột created_at vào equipment_type.';
END
GO
...
BEGIN
    ...
    PRINT N'Đã thêm cột updated_at vào equipment_type.';
END
GO
...
BEGIN
    ...
    PRINT N'Đã thêm cột updated_by và FK vào equipment_type.';
END
GO
