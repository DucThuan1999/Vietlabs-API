-- =============================================
-- Thêm cột người cập nhật (updated_at, updated_by) vào bảng employee
-- =============================================
...
BEGIN
    ...
    PRINT N'Đã thêm cột updated_at vào bảng employee.';
END
ELSE
    PRINT N'Cột updated_at đã tồn tại trong bảng employee.';
GO
...
BEGIN
    ...
    PRINT N'Đã thêm cột updated_by vào bảng employee.';
END
ELSE
    PRINT N'Cột updated_by đã tồn tại trong bảng employee.';
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_employee_updated_by')
BEGIN
    ALTER TABLE [dbo].[employee]
    ADD CONSTRAINT [FK_employee_updated_by]
    FOREIGN KEY ([updated_by]) REFERENCES [dbo].[account] ([account_id]) ON DELETE NO ACTION;
    PRINT N'FK_employee_updated_by đã được tạo.';
END
ELSE
    PRINT N'FK_employee_updated_by đã tồn tại.';
GO
...
PRINT N'Hoàn tất thêm người cập nhật cho employee.';
